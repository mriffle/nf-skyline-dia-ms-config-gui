...
export const paramMetadata: readonly ParamMeta[] = [
  ...
  },
  {
    ...
    help: 'Skip msconvert and feed vendor RAW files straight to the search engine. Only supported by DIA-NN. Cannot be used with overlapping (staggered) DIA windows, since demultiplexing them requires msconvert.',
    tier: 'common',
    widget: 'boolean',
  },
  {
  ...
  },
  {
    ...
    section: 'msconvert',
    label: 'Demultiplex',
    help: 'Set to true if the raw file needs to be demultiplexed (the DIA windows overlap). Demultiplexing is done by msconvert, so this cannot be used together with vendor RAW.',
    tier: 'common',
    widget: 'boolean',
  },
  {
